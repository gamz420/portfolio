        ...
        <div className="info-text">
          ...
          <p>
            {!language
              ...
              : "Hi, I'm Gamzaliev Gamzali, I'm 26 years old and I'm a web developer with experience in developing web applications using React. I also have experience in developing REST APIs using Node JS (Express). I'm familiar with modern ES6 syntax."}
          </p>
          <p>
            {!language
              ...
              : "I'm attentive to detail when it comes to programming and spend most of my time on it. I'm not afraid of tough deadlines, multitasking and demanding clients. I love to learn new things, develop and communicate with cool people."}
          </p>
          <p>
            {!language
