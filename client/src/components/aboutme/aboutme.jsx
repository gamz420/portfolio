    ...
    <div className="aboutme">
      <div className={!theme ? "card" : "cardLight"}>
        ...
        <div className="info-text">
          <h2>HELLO WORLD!</h2>
          <p>
            Привет я Гамзалиев Гамзали, мне 26 лет и я web-разработчик, с опытом
            разработки веб-приложений с использованием React. Также имеется опыт
            разработки REST API с использованием Node JS (Express). Уделяю
            большое внимание грамотному использованию JS, а также знаком с
            современным синтаксисом ES6+.
          </p>
          <p>
